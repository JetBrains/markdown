...
actual class URI actual constructor(str: String) {
    ...
    actual fun resolve(str: String): URI {
        return URI(trimFake(tryCreateURL(str, base).href))
    }
...
""")
private external fun createURL(str: String, base: String? = definedExternally): URL?

private fun tryCreateURL(str: String, base: String? = null): URL {
    return createURL(str, base) ?: throw IllegalArgumentException("Invalid URL string provided: $str")
}
...
actual external fun urlEncode(str: String): String
