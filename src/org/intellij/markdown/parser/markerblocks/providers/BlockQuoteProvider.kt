...
public class BlockQuoteProvider : MarkerBlockProvider<MarkerProcessor.PositionInfo> {
    override fun createMarkerBlock(pos: LookaheadText.Position, positionInfo: MarkerProcessor.PositionInfo): MarkerBlock? {
        ...
        if (nextConstraints != null && nextConstraints?.getLastType() == '>') {
            return BlockQuoteMarkerBlock(nextConstraints, positionInfo.productionHolder.mark())
        } else {
            return null
        }
    }
